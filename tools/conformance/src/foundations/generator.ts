...
export async function buildW1ConformanceManifest(): Promise<W1ConformanceManifest> {
  ...
  // 238 -> 240 (SC-8, 210): credentials.space.share + credentials.shares.list. MEASURED.
  ...
  // 236 -> 238 (SC-8): both share rows ship v1. MEASURED.
  ...
  // GET 78 -> 79, POST 113 -> 114 (SC-8): shares.list, space.share. MEASURED.
  assertEqual(methods, { GET: 79, POST: 114, PATCH: 16, DELETE: 16, PUT: 13, WS: 2 }, 'method accounting');
  ...
  // read 82 -> 83, command 154 -> 155 (SC-8). MEASURED.
  assertEqual(kinds, { read: 83, command: 155, stream: 2 }, 'kind accounting');
  ...
  // 236 -> 238 (SC-8): both share rows are mounted. MEASURED.
