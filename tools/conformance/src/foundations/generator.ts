...
export async function buildW1ConformanceManifest(): Promise<W1ConformanceManifest> {
  ...
  assertEqual(names.length, 248, 'catalog total'); // W11: -1 projects.link, +4 spaces.projects.list/create + gate.folders.list/create. MEASURED. // +2 spaces.chatDefaults.get/set (entity chat G). // +1 launch.defaults (I9b). MEASURED.
  ...
  assertEqual(V1_OPERATIONS.length, 246, 'v1 total'); // W11: -1 projects.link, +4 spaces.projects.list/create + gate.folders.list/create. MEASURED. // +2 spaces.chatDefaults.get/set (entity chat G). // +1 launch.defaults (I9b). MEASURED.
  ...
  assertEqual(methods, { GET: 83, POST: 115, PATCH: 16, DELETE: 17, PUT: 15, WS: 2 }, 'method accounting'); // W11: GET +2, POST -1+2. // GET +1, PUT +1 spaces.chatDefaults.get/set.
  ...
  assertEqual(kinds, { read: 87, command: 159, stream: 2 }, 'kind accounting'); // W11: read +2, command -1+2. // read +1, command +1 spaces.chatDefaults.get/set.
  ...
  assertEqual(router.http.length, 246, 'server router HTTP total'); // W11: -1 projects.link, +4 spaces.projects.list/create + gate.folders.list/create. MEASURED. // +2 spaces.chatDefaults.get/set (entity chat G). // +1 launch.defaults (I9b). MEASURED.
