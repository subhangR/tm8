...
export async function buildW1ConformanceManifest(): Promise<W1ConformanceManifest> {
  ...
  assertEqual(names.length, 269, 'catalog total'); /* +7 spaceLinks.* (W6, 250/251). MEASURED. */ // +1 credentials.space.addMine (W10d). MEASURED. // +3 spaces.leave, spaces.members.remove, accounts.disable (G6, 232). MEASURED. // +2 spaces.chatDefaults.get/set (entity chat G). // +1 launch.defaults (I9b). MEASURED. // +2 auth.sessions.list/revoke (W4). MEASURED.
  ...
  assertEqual(V1_OPERATIONS.length, 267, 'v1 total'); /* +7 spaceLinks.* (W6, 250/251). MEASURED. */ // +1 credentials.space.addMine (W10d). MEASURED. // +3 spaces.leave, spaces.members.remove, accounts.disable (G6, 232). MEASURED. // +2 spaces.chatDefaults.get/set (entity chat G). // +1 launch.defaults (I9b). MEASURED. // +2 auth.sessions.list/revoke (W4). MEASURED.
  ...
  assertEqual(methods, { GET: 87, /* GET +1, POST +5, PATCH +1 spaceLinks.* (W6). MEASURED. */ /* +1 node.metrics.get (status strip). MEASURED. */ /* -1 containers.attention (Attention v2 S7a). MEASURED. */ POST: 128, PATCH: 17, DELETE: 18, PUT: 17, WS: 2 }, 'method accounting'); // W10d: POST +1 credentials.space.addMine. MEASURED. // W11: GET +2, POST +2 (projects.link stays, decision 29). // W10b: GET +1 usage, POST +2 claim/myDefault.set, DELETE +1 myDefault.clear, PUT +2 setVisibility/spaceDefaultConsent. MEASURED. // POST +3 G6 leave/remove/disable. // GET +1, PUT +1 spaces.chatDefaults.get/set. // GET +1 auth.sessions.list, POST +1 auth.sessions.revoke (W4). MEASURED.
  ...
  assertEqual(kinds, { read: 91, /* read +1, command +6 spaceLinks.* (W6). MEASURED. */ /* +1 node.metrics.get (status strip). MEASURED. */ /* -1 containers.attention (Attention v2 S7a). MEASURED. */ command: 176, stream: 2 }, 'kind accounting'); // W10d: +1 command (addMine). MEASURED. // W11: read +2, command +2 (projects.link stays, decision 29). // W10b: +1 read (usage), +5 commands. MEASURED. // command +3 G6 leave/remove/disable. // read +1, command +1 spaces.chatDefaults.get/set. // read +1 auth.sessions.list, command +1 auth.sessions.revoke (W4). MEASURED.
  ...
  assertEqual(router.http.length, 267, 'server router HTTP total'); /* +7 spaceLinks.* (W6). MEASURED. */ /* -1 containers.attention (Attention v2 S7a). MEASURED. */ /* +1 node.metrics.get (status strip). MEASURED. */ // +1 credentials.space.addMine (W10d). MEASURED. // +6 credentials.space.* (W10b). MEASURED. // +3 G6 leave/remove/disable. MEASURED. // +2 spaces.chatDefaults.get/set (entity chat G). // +1 launch.defaults (I9b). MEASURED. // +2 auth.sessions.list/revoke (W4). MEASURED.
