...
export async function buildW1ConformanceManifest(): Promise<W1ConformanceManifest> {
  ...
  // one POST read at /v2/execution/memory-preview. MEASURED.
  ...
  // 196 -> 197: execution.memoryPreview is v1. MEASURED.
  ...
  assertEqual(kinds, { read: 71, command: 126, stream: 2 }, 'kind accounting');
  ...
  // 196 -> 197: execution.memoryPreview mounts as POST
