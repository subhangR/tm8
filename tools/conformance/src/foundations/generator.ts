...
export async function buildW1ConformanceManifest(): Promise<W1ConformanceManifest> {
  ...
  // three POST commands (R7 browser folder import).
  ...
  assertEqual(methods, { GET: 52, POST: 62, PATCH: 10, DELETE: 9, PUT: 7, WS: 1 }, 'method accounting');
  assertEqual(kinds, { read: 55, command: 85, stream: 1 }, 'kind accounting');
