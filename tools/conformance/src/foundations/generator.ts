...
export async function buildW1ConformanceManifest(): Promise<W1ConformanceManifest> {
  ...
  assertEqual(names.length, 249, 'catalog total'); // W11: +4 (projects.link stays, decision 29) spaces.projects.list/create + gate.folders.list/create. MEASURED. // +2 spaces.chatDefaults.get/set (entity chat G). // +1 launch.defaults (I9b). MEASURED.
  ...
  assertEqual(V1_OPERATIONS.length, 247, 'v1 total'); // W11: +4 (projects.link stays, decision 29) spaces.projects.list/create + gate.folders.list/create. MEASURED. // +2 spaces.chatDefaults.get/set (entity chat G). // +1 launch.defaults (I9b). MEASURED.
  ...
  assertEqual(methods, { GET: 83, POST: 116, PATCH: 16, DELETE: 17, PUT: 15, WS: 2 }, 'method accounting'); // W11: GET +2, POST +2 (projects.link stays, decision 29). // GET +1, PUT +1 spaces.chatDefaults.get/set.
  ...
  assertEqual(kinds, { read: 87, command: 160, stream: 2 }, 'kind accounting'); // W11: read +2, command +2 (projects.link stays, decision 29). // read +1, command +1 spaces.chatDefaults.get/set.
  ...
  assertEqual(router.http.length, 247, 'server router HTTP total'); // W11: +4 (projects.link stays, decision 29) spaces.projects.list/create + gate.folders.list/create. MEASURED. // +2 spaces.chatDefaults.get/set (entity chat G). // +1 launch.defaults (I9b). MEASURED.
