...
export async function buildW1ConformanceManifest(): Promise<W1ConformanceManifest> {
  ...
  assertEqual(names.length, 255, 'catalog total'); // +1 credentials.space.addMine (W10d). MEASURED. // +6 credentials.space.* (W10b). MEASURED. // +3 spaces.leave, spaces.members.remove, accounts.disable (G6, 232). MEASURED. // +2 spaces.chatDefaults.get/set (entity chat G). // +1 launch.defaults (I9b). MEASURED.
  ...
  assertEqual(V1_OPERATIONS.length, 253, 'v1 total'); // +1 credentials.space.addMine (W10d). MEASURED. // +6 credentials.space.* (W10b). MEASURED. // +3 spaces.leave, spaces.members.remove, accounts.disable (G6, 232). MEASURED. // +2 spaces.chatDefaults.get/set (entity chat G). // +1 launch.defaults (I9b). MEASURED.
  ...
  assertEqual(methods, { GET: 82, POST: 120, PATCH: 16, DELETE: 18, PUT: 17, WS: 2 }, 'method accounting'); // W10d: POST +1 credentials.space.addMine. MEASURED. // W10b: GET +1 usage, POST +2 claim/myDefault.set, DELETE +1 myDefault.clear, PUT +2 setVisibility/spaceDefaultConsent. MEASURED. // POST +3 G6 leave/remove/disable. // GET +1, PUT +1 spaces.chatDefaults.get/set.
  ...
  assertEqual(kinds, { read: 86, command: 167, stream: 2 }, 'kind accounting'); // W10d: +1 command (addMine). MEASURED. // W10b: +1 read (usage), +5 commands. MEASURED. // command +3 G6 leave/remove/disable. // read +1, command +1 spaces.chatDefaults.get/set.
  ...
  assertEqual(router.http.length, 253, 'server router HTTP total'); // +1 credentials.space.addMine (W10d). MEASURED. // +6 credentials.space.* (W10b). MEASURED. // +3 G6 leave/remove/disable. MEASURED. // +2 spaces.chatDefaults.get/set (entity chat G). // +1 launch.defaults (I9b). MEASURED.
