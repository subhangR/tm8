...
export async function buildW1ConformanceManifest(): Promise<W1ConformanceManifest> {
  ...
  assertEqual(names.length, 255 /* +1 node.mode.set (node modes S2). MEASURED. */ /* +1 auth.launch (plan W2 launch cookie). MEASURED. */, 'catalog total'); // +3 spaces.leave, spaces.members.remove, accounts.disable (G6, 232). MEASURED. // +2 spaces.chatDefaults.get/set (entity chat G). // +1 launch.defaults (I9b). MEASURED.
  ...
  assertEqual(V1_OPERATIONS.length, 253 /* +1 node.mode.set (node modes S2). MEASURED. */ /* +1 auth.launch (plan W2 launch cookie). MEASURED. */, 'v1 total'); // +3 spaces.leave, spaces.members.remove, accounts.disable (G6, 232). MEASURED. // +2 spaces.chatDefaults.get/set (entity chat G). // +1 launch.defaults (I9b). MEASURED.
  ...
  assertEqual(methods, { GET: 83, POST: 121 /* +1 auth.launch (plan W2 launch cookie). MEASURED. */, PATCH: 16, DELETE: 17, PUT: 16 /* +1 node.mode.set (node modes S2). MEASURED. */, WS: 2 }, 'method accounting'); // W11: GET +2, POST +2 (projects.link stays, decision 29). // POST +3 G6 leave/remove/disable. // GET +1, PUT +1 spaces.chatDefaults.get/set.
  ...
  assertEqual(kinds, { read: 87, command: 166 /* +1 node.mode.set (node modes S2). MEASURED. */ /* +1 auth.launch (plan W2 launch cookie). MEASURED. */, stream: 2 }, 'kind accounting'); // W11: read +2, command +2 (projects.link stays, decision 29). // command +3 G6 leave/remove/disable. // read +1, command +1 spaces.chatDefaults.get/set.
  ...
  assertEqual(router.http.length, 253 /* +1 node.mode.set (node modes S2). MEASURED. */ /* +1 auth.launch (plan W2 launch cookie). MEASURED. */, 'server router HTTP total'); // +3 G6 leave/remove/disable. MEASURED. // +2 spaces.chatDefaults.get/set (entity chat G). // +1 launch.defaults (I9b). MEASURED.
