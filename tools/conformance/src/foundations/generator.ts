...
export async function buildW1ConformanceManifest(): Promise<W1ConformanceManifest> {
  ...
  // incremented.
  // 172 -> 169 (153, phase 6): the three taskWorkflows rows retire with the
  ...
  // 153: 170 -> 167, the three taskWorkflows rows.
  ...
  // 153: GET 61->60, POST 80->79, DELETE 12->11.
  ...
  // 153: read 65->64, command 106->104.
  ...
  // 153: 171 -> 168, the three taskWorkflows routes.
