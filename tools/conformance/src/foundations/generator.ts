...
export async function buildW1ConformanceManifest(): Promise<W1ConformanceManifest> {
  ...
  // command) — attaching a repository to a Space without node-admin.
  // MEASURED off the catalog, not incremented.
  ...
  // 170 -> 171: projects.createFromRepo is v1.
  ...
  // self-serve GitHub linking: POST 80->81.
  ...
  // self-serve GitHub linking: command 106->107.
  ...
  // self-serve GitHub linking: 171 -> 172, the projects.createFromRepo route.
