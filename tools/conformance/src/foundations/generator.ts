...
export async function buildW1ConformanceManifest(): Promise<W1ConformanceManifest> {
  ...
  // — the kind x category matrix. MEASURED off the catalog, not incremented.
  ...
  // 170 -> 171: collections.counts is v1.
  ...
  // rail counts: read 65->66.
  assertEqual(kinds, { read: 66, command: 106, stream: 1 }, 'kind accounting');
  ...
  // rail counts: 171 -> 172, the collections.counts route.
