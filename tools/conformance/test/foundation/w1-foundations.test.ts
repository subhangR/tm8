...
describe('W1.C generated catalog and reachability foundations', () => {
  it('derives exact current catalog, router, status, method, and kind accounting', async () => {
    ...
    expect(manifest.catalog).toEqual({
      ...
      total: 248, /* W11: -1 projects.link, +4 spaces.projects.list|create and gate.folders.list|create. MEASURED. */ /* +2 spaces.chatDefaults.get/set (entity chat G). MEASURED. */ /* +1 launch.defaults (I9b). MEASURED. */ /* +2 forms.responses.redeliver, forms.pendingForSessions (Forms W3), on the merged tree. MEASURED. */ /* +2 entities.header.set/clear (headers I4). MEASURED. */ /* +13 forms.* (Forms W1). MEASURED. */ // +1 spaces.configs (task 01a0d350). // +1 entities.commands.tick (bug 01a0d2f1). +1 events.changes (change feed step 3).
      v1: 246, /* W11: -1 projects.link, +4 spaces.projects.list|create and gate.folders.list|create. MEASURED. */ /* +2 spaces.chatDefaults.get/set (entity chat G). MEASURED. */ /* +1 launch.defaults (I9b). MEASURED. */ /* +2 forms.responses.redeliver, forms.pendingForSessions (Forms W3), on the merged tree. MEASURED. */ /* +2 entities.header.set/clear (headers I4). MEASURED. */ /* +13 forms.* (Forms W1). MEASURED. */ // +1 spaces.configs. // +1 entities.commands.tick. +1 events.changes (change feed step 3).
      reserved: 2,
      http: 246, /* W11: -1 projects.link, +4 spaces.projects.list|create and gate.folders.list|create. MEASURED. */ /* +2 spaces.chatDefaults.get/set (entity chat G). MEASURED. */ /* +1 launch.defaults (I9b). MEASURED. */ /* +2 forms.responses.redeliver, forms.pendingForSessions (Forms W3), on the merged tree. MEASURED. */ /* +2 entities.header.set/clear (headers I4). MEASURED. */ /* +13 forms.* (Forms W1). MEASURED. */ // +1 spaces.configs. // +1 entities.commands.tick. +1 events.changes (change feed step 3).
      ws: 1,
      registerableV1Http: 244, /* W11: -1 projects.link, +4 spaces.projects.list|create and gate.folders.list|create. MEASURED. */ /* +2 spaces.chatDefaults.get/set (entity chat G). MEASURED. */ /* +1 launch.defaults (I9b). MEASURED. */ /* +2 forms.responses.redeliver, forms.pendingForSessions (Forms W3), on the merged tree. MEASURED. */ /* +2 entities.header.set/clear (headers I4). MEASURED. */ /* +13 forms.* (Forms W1). MEASURED. */ // +1 spaces.configs. // +1 entities.commands.tick. +1 events.changes (change feed step 3).
      methods: { GET: 83, /* W11: GET +2 (spaces.projects.list, gate.folders.list), POST -1 projects.link +2 creates. MEASURED. */ /* +1 spaces.chatDefaults.get. MEASURED. */ /* +1 launch.defaults (I9b). MEASURED. */ /* +13 forms.* (Forms W1). MEASURED. */ /* GET +1, POST +1 (Forms W3). MEASURED. */ POST: 115, PATCH: 16, DELETE: 17, PUT: 15 /* +1 spaces.chatDefaults.set. MEASURED. */, WS: 2 }, /* +2 entities.header.set/clear (headers I4). MEASURED. */ // +1 events.changes (change feed step 3).
      kinds: { read: 87, /* W11: read +2, command -1+2. MEASURED. */ /* +1 spaces.chatDefaults.get, command +1 spaces.chatDefaults.set. MEASURED. */ /* +1 launch.defaults (I9b). MEASURED. */ /* +13 forms.* (Forms W1). MEASURED. */ /* read +1, command +1 (Forms W3). MEASURED. */ command: 159, stream: 2 }, /* +2 entities.header.set/clear (headers I4). MEASURED. */ // +1 events.changes (change feed step 3).
      uniqueNames: 248, /* W11: -1 projects.link, +4 spaces.projects.list|create and gate.folders.list|create. MEASURED. */ /* +2 spaces.chatDefaults.get/set (entity chat G). MEASURED. */ /* +1 launch.defaults (I9b). MEASURED. */ /* +2 forms.responses.redeliver, forms.pendingForSessions (Forms W3), on the merged tree. MEASURED. */ /* +2 entities.header.set/clear (headers I4). MEASURED. */ /* +13 forms.* (Forms W1). MEASURED. */ // +1 spaces.configs. // +1 entities.commands.tick. +1 events.changes (change feed step 3).
      uniqueBindings: 247, /* W11: -1 projects.link, +4 spaces.projects.list|create and gate.folders.list|create. MEASURED. */ /* +2 spaces.chatDefaults.get/set (entity chat G). MEASURED. */ /* +1 launch.defaults (I9b). MEASURED. */ /* +2 forms.responses.redeliver, forms.pendingForSessions (Forms W3), on the merged tree. MEASURED. */ /* +2 entities.header.set/clear (headers I4). MEASURED. */ /* +13 forms.* (Forms W1). MEASURED. */ // +1 spaces.configs. // +1 entities.commands.tick. +1 events.changes (change feed step 3).
    });
  ...
  it('keeps implementation accounting honest at 28 handlers and 36 actual input bindings', async () => {
    ...
    expect(manifest.serverRegistries.unimplementedV1Http).toBe(216); /* W11: -1 projects.link, +4 spaces.projects.list|create and gate.folders.list|create. MEASURED. */ /* +2 spaces.chatDefaults.get/set (entity chat G). MEASURED. */ /* +1 launch.defaults (I9b). MEASURED. */ /* +2 forms.responses.redeliver, forms.pendingForSessions (Forms W3), on the merged tree. MEASURED. */ /* +2 entities.header.set/clear (headers I4). MEASURED. */ /* +13 forms.* (Forms W1). MEASURED. */ /* +1 spaces.configs (task 01a0d350). MEASURED. */ /* +1 entities.commands.tick (bug 01a0d2f1). MEASURED. */ /* +1 events.changes (change feed step 3). MEASURED. */ // 180 -> 190 (SC-3). 177 -> 180 (Jev lane K).
  ...
  it('keeps prompt internal-only, reserved help honest, and WS durability unclaimed', async () => {
    ...
    // 2026-09-23 (filesystem skills INTEGRATED WITH main): skills.scan/list/show/preview, all v1 HTTP (3 GET/read, 1 POST/command). MEASURED on the merged tree.
    expect(manifest.help.operations).toHaveLength(248); /* W11: -1 projects.link, +4 spaces.projects.list|create and gate.folders.list|create. MEASURED. */ /* +2 spaces.chatDefaults.get/set (entity chat G). MEASURED. */ /* +1 launch.defaults (I9b). MEASURED. */ /* +2 forms.responses.redeliver, forms.pendingForSessions (Forms W3), on the merged tree. MEASURED. */ /* +2 entities.header.set/clear (headers I4). MEASURED. */ /* +13 forms.* (Forms W1). MEASURED. */ /* +1 spaces.configs (task 01a0d350). MEASURED. */ /* +1 entities.commands.tick (bug 01a0d2f1). MEASURED. */ /* +1 events.changes (change feed step 3). MEASURED. */ // +10 (SC-3). // +3 service keys (Jev lane K). // +1 launch.suggest (Jev lane F). MEASURED.
...
describe('W2.C01 current mounted registry inventory', () => {
  it('proves the exact I03 tranche-v3 handler and input-schema boundary from current source', async () => {
    ...
    expect(handlers.all).toHaveLength(244); /* W11: -1 projects.link, +4 spaces.projects.list|create and gate.folders.list|create. MEASURED. */ /* +2 spaces.chatDefaults.get/set (entity chat G). MEASURED. */ /* +1 launch.defaults (I9b). MEASURED. */ /* +2 forms.responses.redeliver, forms.pendingForSessions (Forms W3), on the merged tree. MEASURED. */ /* +2 entities.header.set/clear (headers I4). MEASURED. */ /* +13 forms.* (Forms W1). MEASURED. */ /* +1 spaces.configs (task 01a0d350). MEASURED. */ /* +1 entities.commands.tick (bug 01a0d2f1). MEASURED. */ /* +1 events.changes (change feed step 3). MEASURED. */ // +10 (SC-3). +3 (Jev lane K). MEASURED.
    ...
    expect(createHash('sha256').update(JSON.stringify(handlers.all)).digest('hex'))
      ...
      .toBe('987535a2365c698dd3a83e89fe565e748b93709ee5f94d3d4a2292d50b812efd'); // Re-measured (W11): projects.link leaves, spaces.projects.list/create + gate.folders.list/create join; read from the failing run's Received line. // Re-measured (entity chat G): spaces.chatDefaults.get/set join; read from the failing run. // Re-measured (I9b): launch.defaults joins; read from the failing run. Prior (headers I4): entities.header.set/clear join; read from the failing run's Received line. Re-measured (Forms W3, merged with I4): the two forms handlers join; read from the failing run's Received line.
    ...
    expect(inputSchemas.bound).toHaveLength(151) /* W11: -1 projects.link, +1 spaces.projects.create, +1 gate.folders.create. MEASURED. */ /* +1 spaces.chatDefaults.set (entity chat G). MEASURED. */ /* +1 forms.responses.redeliver (Forms W3), on the merged tree. MEASURED. */ /* +2 entities.header.set/clear bind their input schemas (headers I4). MEASURED. */ /* +10 forms.* command schemas (Forms W1). MEASURED. */ // +1: entities.commands.tick binds TickCriteriaInputSchema (bug 01a0d2f1). +7: the SC-3 space/node credential commands bind. +2: service-key put and delete bind (Jev lane K).
