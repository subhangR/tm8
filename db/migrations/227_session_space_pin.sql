...
--
-- NOT COVERED HERE (W3's audit, reported to the coordinator): policies that
-- inline their own membership instead of calling a helper — user_profiles,
-- read_marks, file_upload_slots, notifications,
-- work_session_view_preferences, and the public arm of spaces_select.
-- =============================================================================
