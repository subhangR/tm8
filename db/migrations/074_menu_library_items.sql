-- 074 — Files, Spells and Collections enter the shipped menu (2026-08-09).
--
-- These kinds have always had collection routes, but the shipped menu named
-- none of them. A dedicated Library group makes all three reachable without
-- exceeding the Workspace caret's eight-child contract cap.
--
-- Existing customized menus remain untouched. Only the exact 071 default is
-- upgraded, using the same compare-before-replace discipline as 059/069/071.
