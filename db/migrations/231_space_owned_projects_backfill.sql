-- =============================================================================
-- 231 — space-owned projects, the backfill (plan 01a0d9eb W11).
--
-- ROW-REWRITING. 230 added the columns and fills them for every new row; this
-- file fills them for the rows that existed before 230. It writes ONLY the
