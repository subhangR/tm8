...
describeDb('default-menu seeder parity (the 059 lesson)', () => {
  ...
  it('serves NO work or channels group — 134 retired both into the unified Home', async () => {
