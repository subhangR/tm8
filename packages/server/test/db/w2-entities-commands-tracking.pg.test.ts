...
// src, and src's shared read SQL references columns born in later migrations
// (ppd.name: 021, interaction_profiles' full set: 027) — a pinned slice
// re-breaks on every schema-coupled src change. Matches this file's own :577
// rationale and the :703 usage.
