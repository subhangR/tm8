...
describe.sequential('task assignment provenance (129)', () => {
  beforeAll(async () => {
    ...
    // …and ONE COLUMN of 155, for the third time and the same reason: current
    ...
    //
    // Unlike 135 and 147 above, 155 CANNOT be applied whole: it drops
    ...
    // base_kind IS the pre-155 world.
