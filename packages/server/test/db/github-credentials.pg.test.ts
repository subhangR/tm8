/** 093 against real Postgres: RLS, grants, human mutations, and spawn read. */
...
beforeAll(async () => {
  database = await createW1ScratchDatabase('github_credentials_093');
...
describe('093 account_git_credentials security posture', () => {
