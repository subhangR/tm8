 ...
 * (migration 217), end to end against a real scratch database.
 *
 ...
 * Everything between them — 217's doors, the claim, 215's handlers — is the
 * production code.
 */
...
describe('forms.responses.redeliver: send a cancelled delivery to a new session', () => {
  ...
  it('a redelivered row survives the session_deleted sweep while still pending (217 C)', async () => {
