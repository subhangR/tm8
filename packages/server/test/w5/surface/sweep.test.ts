...
describe('W5.C schema-valid stub sweep — all 98 v1 non-WS operations', () => {
  ...
  it('applies the FULL migration chain, enumerated rather than hand-listed', () => {
    ...
    // 81 -> 82: 087 (single-use, hash-only PTY grants).
    // 83 -> 84: 093 (per-account string-shaped GitHub credentials), measured
    // from this final tree rather than inferred across concurrent branches.
