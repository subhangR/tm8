...
describe('W5.C schema-valid stub sweep — all 98 v1 non-WS operations', () => {
  ...
  it('applies the FULL migration chain, enumerated rather than hand-listed', () => {
    ...
    expect(server.appliedMigrations.length).toBe(220); // 218 -> 220: 250_space_link_kinds + 251_space_link_tokens (W6 #864) on top of #863's 239_credential_entities (218). Main + own delta: #863 218 + W6 2. MEASURED at the #863 merge: ls db/migrations/*.sql | wc -l -> 220.
