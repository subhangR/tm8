...
describe('W5.C schema-valid stub sweep — all 98 v1 non-WS operations', () => {
  ...
  it('applies the FULL migration chain, enumerated rather than hand-listed', () => {
    ...
    expect(server.appliedMigrations.length).toBe(221); // measured; main's 218 literal is the #901 red. 221 = ls db/migrations/*.sql on the W6 merged head: main 4337c807's 219 files (#863 239_credential_entities, #901 253_chat_authored_delivery_source) + W6's 250_space_link_kinds and 251_space_link_tokens. MEASURED.
