...
describe('W5.C schema-valid stub sweep — all 98 v1 non-WS operations', () => {
  ...
  it('applies the FULL migration chain, enumerated rather than hand-listed', () => {
    ...
    // 94 -> 96 on 2026-08-11, two files in one wave: 100 (Phase 0 containment —
    // node admin resolved from `accounts` rather than the claim, plus the
    // orphaned-agent-credential sweep doors) and 101 (the control plane —
