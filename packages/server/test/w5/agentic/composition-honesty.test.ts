...
describe('W5.F composition honesty — the presence source is the whole delta', () => {
  ...
  it('CONTROL — the denominator is the 127 v1 HTTP rows, by exact count and exact membership', () => {
    // 118 -> 122 (2026-08-02): the four auth.* rows (Identity v2 Stage 1).
    // 123 -> 125 (2026-08-04): projects.files.list and projects.files.attach.
    // 125 -> 127 (2026-08-07): collections.addItem and collections.removeItem.
  ...
  it('BOTH READINGS ARE CORRECT — 127/0 and 126/1 name the two compositions, not a defect', () => {
