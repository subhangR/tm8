  ...
  it('validates the live catalog digest and exposes only bounded noun summaries at root', async () => {
    ...
    expect(response.result).toMatchObject({
      ...
      nouns: expect.arrayContaining([
        ...
        { noun: 'space', operationCount: 35 }, // +2 spaces.leave, spaces.members.remove (G6, 230). MEASURED. +2 spaces.chatDefaults.get/set (entity chat G). MEASURED. +1 spaces.configs (task 01a0d350). +3 (148): spaces.workflows.*
      ]),
    });
