...
/* +7 spaceLinks.* (W6, 243/244): the regenerated manifest digest, equal to the CLI CATALOG_DIGEST. MEASURED. */ /* +2 forms.responses.redeliver, forms.pendingForSessions (Forms W3), merged with headers I4. MEASURED. */ /* +13 forms.* (Forms W1). MEASURED. */ /* Re-measured (G6, 232): +3 spaces.leave, spaces.members.remove, accounts.disable. MEASURED. */ const CATALOG_DIGEST = 'sha256:3b8dcc96fcc96d2e640bdf6794ab7f5ba5dde491274e8f5b12c010038be27e78' /* I9b: + launch.defaults */ /* headers I4: + entities.header.set/clear; matched to the regenerated manifest. */; /* +1 entities.commands.tick (bug 01a0d2f1). MEASURED. */ // SC-3: +10 space/node credential rows; /* +1 events.changes (change feed step 3). MEASURED. */ Jev lane K: +3 service-key rows
