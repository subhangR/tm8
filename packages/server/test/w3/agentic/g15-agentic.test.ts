...
/* +2 SC-8 share rows. MEASURED. */ /* +13 forms.* (Forms W1). MEASURED. */ const CATALOG_DIGEST = 'sha256:bd1db763eec8d7474035aa13f71c166e9078790783dd6510c9556bb8cbe28898'; /* +1 entities.commands.tick (bug 01a0d2f1). MEASURED. */ // SC-3: +10 space/node credential rows; /* +1 events.changes (change feed step 3). MEASURED. */ Jev lane K: +3 service-key rows
