...
/* -1 containers.attention (Attention v2 S7a): the regenerated manifest digest. MEASURED. */ /* +7 spaceLinks.* (W6, 250/251, re-stacked on f54f9ffd): the regenerated manifest digest, equal to the CLI CATALOG_DIGEST. MEASURED. */ /* +2 auth.sessions.list/revoke (W4, on main 96f6b61e): the regenerated manifest digest. MEASURED. */ /* W11: +4 ops (projects.link stays, decision 29), rebased onto main d11e0be5 (#848); same digest as packages/cli CATALOG_DIGEST, re-measured on the rebased tree. */ /* +1 auth.space.enter (W3-server, on main bd1841bf): the conformance generator's digest, copied. MEASURED. */ /* +2 forms.responses.redeliver, forms.pendingForSessions (Forms W3), merged with headers I4. MEASURED. */ /* +13 forms.* (Forms W1). MEASURED. */ /* Re-measured (G6, 232): +3 spaces.leave, spaces.members.remove, accounts.disable. MEASURED. */ /* +3 attentionRequests.markSeen|unresolve|withdraw (Attention v2 S4): the regenerated digest. MEASURED. */ const CATALOG_DIGEST = 'sha256:3450e1eacdc49ecc0b430036b2af76165d7c2fdc80c34d6275a890be14a9eb87' /* I9b: + launch.defaults */ /* headers I4: + entities.header.set/clear; matched to the regenerated manifest. */; /* +1 entities.commands.tick (bug 01a0d2f1). MEASURED. */ // SC-3: +10 space/node credential rows; /* +1 events.changes (change feed step 3). MEASURED. */ Jev lane K: +3 service-key rows
