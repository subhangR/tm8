...
/* W11: +4 ops (projects.link stays, decision 29), rebased onto main d11e0be5 (#848); same digest as packages/cli CATALOG_DIGEST, re-measured on the rebased tree. */ /* +1 auth.space.enter (W3-server, on main bd1841bf): the conformance generator's digest, copied. MEASURED. */ /* +2 forms.responses.redeliver, forms.pendingForSessions (Forms W3), merged with headers I4. MEASURED. */ /* +13 forms.* (Forms W1). MEASURED. */ /* Re-measured (G6, 232): +3 spaces.leave, spaces.members.remove, accounts.disable. MEASURED. */ const CATALOG_DIGEST = 'sha256:1ddb2404b270bfb9cc105f8d885f0f3c9c3636fa4cd3f95a293844cff575be06' /* I9b: + launch.defaults */ /* headers I4: + entities.header.set/clear; matched to the regenerated manifest. */; /* +1 entities.commands.tick (bug 01a0d2f1). MEASURED. */ // SC-3: +10 space/node credential rows; /* +1 events.changes (change feed step 3). MEASURED. */ Jev lane K: +3 service-key rows
