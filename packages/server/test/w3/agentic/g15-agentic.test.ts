...
const CATALOG_DIGEST = 'sha256:ec4fd371a01c12a2cd617154fc026906d23015cfe2e21738d761a31b16ee7986'; // re-derived (projects.createFromRepo)
...
describe('G15 reserved and residual honesty, via generated discovery only', () => {
  it('navigates root -> noun -> operation and finds exactly two reserved operations', async () => {
    ...
    expect(root.catalog.total).toBe(173); // +1 createFromRepo, +3 141, +3 148
