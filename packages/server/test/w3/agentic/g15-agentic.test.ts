...
/* +2 spaceLinks.invoke/audit (W7, 990): regenerated manifest digest = CLI CATALOG_DIGEST. MEASURED. */ /* +7 spaceLinks.* (W6, 243/244): the regenerated manifest digest, equal to the CLI CATALOG_DIGEST. MEASURED. */ /* +2 forms.responses.redeliver, forms.pendingForSessions (Forms W3), merged with headers I4. MEASURED. */ /* +13 forms.* (Forms W1). MEASURED. */ /* Re-measured (G6, 232): +3 spaces.leave, spaces.members.remove, accounts.disable. MEASURED. */ const CATALOG_DIGEST = 'sha256:4201f8cb2f4e561a9ae4e239cec5d2401257c6cffec74775849368a82f5a2088' /* I9b: + launch.defaults */ /* headers I4: + entities.header.set/clear; matched to the regenerated manifest. */; /* +1 entities.commands.tick (bug 01a0d2f1). MEASURED. */ // SC-3: +10 space/node credential rows; /* +1 events.changes (change feed step 3). MEASURED. */ Jev lane K: +3 service-key rows
