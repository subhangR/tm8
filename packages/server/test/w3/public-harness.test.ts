...
describe.sequential('W3 production-Server public harness', () => {
  ...
  it('starts the real database-backed production composition', async () => {
    ...
    expect(body).toMatchObject({
      ...
      operations: 168, // -3 (154): the spaces.taskWorkflows routes retire // +3 148: the spaces.workflows routes
    });
    ...
    expect(body.implemented).toBe(166); // -3 154: the taskWorkflows three retire
