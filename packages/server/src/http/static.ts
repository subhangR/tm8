 ...
 *
 * ONE BUNDLE, SINCE 2026-09-06. This handler used to take a `mountPath`, so a
 * second UI package could be served under a prefix (`/ui-2.0/`) beside the
 * product one on the same origin. Both extra UI packages were deleted; there
 * is nothing left to mount, and the prefix machinery went with them rather
 * than staying as an untravelled branch in the path that resolves files.
 */
