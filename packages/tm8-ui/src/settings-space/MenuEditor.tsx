 ...
 * disabled-with-reason, ALWAYS, and the version-lock state's own disabled Save
 * (L383, which the oracle draws disabled too) is the one place oracle and R7
 * already agree.
 *
  ...
  return (
    <div className="set-menu">
      ...
      <div className="set-menu__editor set-panel">
        <div className="set-menu__head">
          <span className="set-menu__title">Menu</span>
        ...
        {issue ? (
          <div className="set-absent" data-testid="menu-issue">
            <span className="set-absent__head">The rail would refuse this menu.</span>
            <span className="set-absent__why">{issue}</span>
          </div>
        ) : null}
        ...
        <div className="set-menu__rows">
          ...
          {/* the three creators (oracle L324–L328) */}
      ...
      {/* ---------------------------------------------------------------- */}
      <div className="set-menu__preview set-panel">
      ...
      {/* ---------------------------------------------------------------- */}
      {/* the two states beside the editor                                  */}
      {/* ---------------------------------------------------------------- */}
      <div className="set-menu__states">
        {conflictRevision !== null && conflictRevision > config.revision ? (
          <div className="set-state" data-testid="menu-conflict">
            ...
            <div className="set-state__banner set-state__banner--info">
              ...
              <div className="set-state__text">
                ...
                <span className="set-state__body">
                  This editor holds v{config.revision}; the space is on v{conflictRevision}. Reload to
                  edit — your unsaved reorder will be lost.
                </span>
              </div>
              <DisabledIconControl
            ...
            <span className="set-state__foot">
              last-write-wins everywhere else; the editor is the one surface that warns before losing
              work
            </span>
          </div>
        ) : null}
          ...
          <div className="set-state" data-testid="menu-version-lock">
            ...
            <div className="set-state__banner set-state__banner--warn">
              ...
              <div className="set-state__text">
                ...
                <span className="set-state__body">
                  This menu uses features this build doesn’t know. Read-only here — the rail still
                  renders what it understands, and unknown refs fall back to ◇.
                </span>
              </div>
            </div>
            <DisabledAction reason={MENU_SAVE_VERSION_LOCKED} label="save menu (version locked)">
              Save menu
            </DisabledAction>
          </div>
        ) : null}
  ...
  return (
    <>
      ...
      {item.type === 'view' && children.length > 0 ? (
        <div className="set-row set-row--child">
          {canAddChild ? (
            <button
              type="button"
              className="set-add"
