...
export type { EntityChatSlotProps, NewChatGate } from './EntityChatSlot';
export { NewChatSettings } from './NewChatSettings';
export type { NewChatSettingsProps, NewChatSettingsSeam } from './NewChatSettings';
