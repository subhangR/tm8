...
import type {
  ...
  ProjectFileListing, ProjectFileRevision, ProjectRevisionDiff,
...
export const MenuViewRefSchema = z.enum(['dashboard', 'feed', 'inbox', 'workspace', 'graph', 'channels', 'settings', 'git']);
