...
it('starts a real Server and reports an un-enveloped /health', async () => {
  ...
  expect(h.operations).toBe(129); // 126 -> 129 (2026-08-09): files.browse + files.read, plus one route this pin had ALREADY drifted past. MEASURED off /health, not previous-plus-two.
