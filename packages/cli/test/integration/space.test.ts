...
describe('the node itself', () => {
  it('reports an un-enveloped /health with the frozen route count', async () => {
    ...
    expect(health.operations).toBe(168) /* 171→168 153: spaces.taskWorkflows.* retired — ROUTES, not catalog rows */ /* 168→171 148: spaces.workflows.* */ /* 157→158 2026-08-13: #188 chat route */; // MEASURED off /health; +1 2026-08-13 tracking.pr.merge.
