...
describe('the node itself', () => {
  it('reports an un-enveloped /health with the frozen route count', async () => {
    ...
    expect(health.operations).toBe(172) /* 171→172: projects.createFromRepo */ /* 168→171 148: spaces.workflows.* — ROUTES, not catalog rows */ /* 162→165 2026-08-16 W4/132: spaces.taskWorkflows.* */ /* 157→158 2026-08-13: #188 chat route */; // MEASURED off /health; +1 2026-08-13 tracking.pr.merge.
