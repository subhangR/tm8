...
describe('the node this suite measured', () => {
  it('reports its mounted and registered counts, and 101 mounted routes', async () => {
    ...
    expect(health.operations).toBe(196) /* 195→196 2026-09-15 186: memories.search — one POST route, MEASURED off /health */ /* 171→195 177: the 24 container HTTP routes — ROUTES, not catalog rows */ /* 168→171 148: spaces.workflows.* — ROUTES, not catalog rows */ /* 162→165 2026-08-16 W4/132: spaces.taskWorkflows.* */ /* 157→158 2026-08-13: #188 chat route */;
