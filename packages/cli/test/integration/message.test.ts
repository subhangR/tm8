...
describe('the node this suite measured', () => {
  it('reports its mounted and registered counts, and 101 mounted routes', async () => {
    ...
    expect(health.operations).toBe(172) /* 171→172: chat.threads.interrupt — ROUTES, not catalog rows */ /* 162→165 2026-08-16 W4/132: spaces.taskWorkflows.* */ /* 157→158 2026-08-13: #188 chat route */;
