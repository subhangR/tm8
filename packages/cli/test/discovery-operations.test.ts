...
describe('cross-check: the projection agrees with the W1 conformance manifest', () => {
  it('sweeps all 152 manifest help rows and agrees on noun and exposure', () => {
...
describe('the exposure histogram is the one the catalog freeze specifies', () => {
  it('148 public, 1 composite, 1 internal, 2 reserved', () => {
    ...
    expect(histogram).toEqual({ public: 148, composite: 1, internal: 1, reserved: 2 });
  });
});
