...
describe('W5.F PIN 1 (CONVERTED) — availabilitySource names a source that produced it', () => {
  ...
  it('BLAST RADIUS, CONVERTED — the two populations are now distinguishable', () => {
    ...
    expect(rows).toHaveLength(173); // +1 projects.createFromRepo, +3 148 (spaces.workflows)
    ...
    expect(unknownRows).toHaveLength(171) /* 167 -> 170 (148): the three spaces.workflows rows, non-reserved */;
