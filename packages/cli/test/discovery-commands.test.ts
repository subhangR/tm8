...
describe('the registry is composed from per-noun modules, and agrees with the projection', () => {
  ...
  it('the projection holds 127 command paths; the registry is an honest subset of them', () => {
    ...
    // 123 -> 125 (worktrees): `worktree list` and `worktree status` are ALIASES
    ...
    // 125 -> 127 (2026-08-09): project contention + task gate (Tier 4 git x graph).
