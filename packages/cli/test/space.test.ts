...
describe('the registered command set', () => {
  it('registers all 27 Space rows and nothing that is not in the projection', async () => {
    ...
    expect(paths).toHaveLength(35); /* +2 space leave, space member remove (G6, 232). MEASURED. */ // +2 space chat-defaults get/set (entity chat G) // +1 space configs get (task 01a0d350)
