...
export const KIND_ART = {
  ...
  /**
   * Two overlapping speech bubbles — a conversation, not a message (one bubble)
   * and not a channel (a hash). 176 REPAIR: copied from tm8-ui's mark so the
   * two trees cannot draw a chat differently.
   */
  chat: [
