...
const SHELL = {"critical":["/index.html","/assets/index-nHsBkdS2.css","/assets/index-CKbB-BZn.js"],"optional":["/manifest.webmanifest","/icons/icon-192.png","/icons/icon-512.png","/icons/icon-maskable-512.png","/icons/apple-touch-icon-180.png","/favicon.ico","/tm8-mark.png","/fonts/HankenGrotesk-400-latin.woff2","/fonts/HankenGrotesk-600-latin.woff2"]};
const BUILD = "f817ec312d0a";
