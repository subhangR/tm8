...
# THERE IS NO SECOND BUNDLE. TM8_UI_2_0_DIR mounted the Astryx redesign at
# /ui-2.0/ until 2026-09-15, when that package was deleted; the server no
# longer reads the variable. A leftover `TM8_UI_2_0_DIR=` line in a deployed
# /etc/tm8/prod.env is inert, and deploy/utho/deploy.sh strips it.
