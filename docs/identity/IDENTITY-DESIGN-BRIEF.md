...
Read `TM8-AUTH-AND-IDENTITY-BRIEF.md` (same directory, rev 3) in full first. It is verified against the tree with `file:line` evidence. Companions: `TM8-REMOTE-DEEP-REPORT.md` and `REMOTE-DEEP-REPORT-B.md`.
