...
2026-07-31 into `docs/features/foundation/NEW-ENTITIES-SESSION-DIGEST.md` §4.
...
documents under `docs/features/artifacts/` is expected and fine.

## 2. Read before you write

- `docs/features/foundation/NEW-ENTITIES-SESSION-DIGEST.md` — §4 and §5 are yours
- `docs/architecture/10-SECURITY-MODEL.md` — the S-numbered gates; S2 Host, S3 Origin, S4 CORS,
  S6 CSRF are named as release blockers below. **Verify whether they are still unimplemented.**
- `docs/architecture/03-ENTITY-GRAPH-DELTAS.md`, `01-LAWS.md`
...
Write to `docs/features/artifacts/ARTIFACTS-DESIGN.md` — this document does not exist yet and is the main
