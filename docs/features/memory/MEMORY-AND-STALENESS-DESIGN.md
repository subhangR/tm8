...
Produced against the requirements brief `MEMORY-STALENESS-DESIGN-BRIEF.md` and the evidence in
`PROGRAM-CLOSE.md` and `W0-W5-HANDOFF-STATE.md` §§15, 21–24.
...
`PROGRAM-CLOSE.md:28` said **fourteen** coordinator figures fell while the same document at
...
were scrubbed and the discrepancy recorded in their place (`PROGRAM-CLOSE.md:31-32`,
