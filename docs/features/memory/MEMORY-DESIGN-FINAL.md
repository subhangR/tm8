...
`MEMORY-AND-STALENESS-DESIGN.md` and `MEMORY-STALENESS-API-CLI-DESIGN.md`. Those two
...
computed once, delivered identically to every consumer"* (`docs/architecture/01-LAWS.md:84`).
...
**Three requirements sent to the worktrees worker** (`docs/features/foundation/MEMO-MEMORY-SEAM-QUESTIONS.md`,
...
7. **Worktrees — ANSWERED and closed.** Superseding this item's earlier text: the worktrees worker
   replied in `docs/features/foundation/MEMO-WORKTREE-SEAM-ANSWERS.md`, marked binding, accepting all three
