...
recovered on 2026-07-31 and digested into `docs/features/foundation/NEW-ENTITIES-SESSION-DIGEST.md`.
...
new documents under `docs/features/memory/` is expected and fine.

## 2. Read before you write

Existing design docs, in dependency order:

- `docs/features/memory/MEMORY-STALENESS-DESIGN-BRIEF.md`
- `docs/features/memory/MEMORY-AND-STALENESS-DESIGN.md` — the main design
- `docs/features/memory/MEMORY-STALENESS-API-CLI-DESIGN.md` — wire and CLI surface
- `docs/features/memory/MEMORY-STALENESS-DESIGN-REVIEW.md` — adversarial review
- `docs/features/foundation/NEW-ENTITIES-SESSION-DIGEST.md` — the recovery digest; §2 and §5 are yours

Architecture context:

- `docs/architecture/03-ENTITY-GRAPH-DELTAS.md`
- `docs/architecture/01-LAWS.md`, `05-DECISIONS.md`
...
Write to `docs/features/memory/MEMORY-DESIGN-FINAL.md` (or amend the existing design docs in place and
