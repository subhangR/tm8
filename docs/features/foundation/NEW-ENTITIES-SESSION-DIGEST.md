...
`docs/features/memory/MEMORY-AND-STALENESS-DESIGN.md`, `MEMORY-STALENESS-API-CLI-DESIGN.md`,
`MEMORY-STALENESS-DESIGN-BRIEF.md`, `docs/features/memory/MEMORY-STALENESS-DESIGN-REVIEW.md`.
...
realpath-containment rule lives only in `docs/architecture/10-SECURITY-MODEL.md:36`.
