...
- `docs/features/foundation/NEW-ENTITIES-SESSION-DIGEST.md` — what the three features are
- `docs/features/memory/MEMORY-DESIGN-FINAL.md` (1230 ln)
- `docs/features/worktrees/WORKTREE-DESIGN.md` (1066 ln)
- `docs/features/artifacts/ARTIFACTS-DESIGN.md` (1473 ln)
- `docs/features/foundation/MEMO-MEMORY-SEAM-QUESTIONS.md`, `docs/features/foundation/MEMO-WORKTREE-SEAM-ANSWERS.md`
...
`docs/features/foundation/` for the working invocation, and report the one that worked.
...
1. **`docs/features/foundation/FOUNDATION-VERIFICATION.md`** — V1 through V7, each with the command run, the
...
4. **`docs/features/foundation/BUILD-ORDER-AND-OWNERSHIP.md`** — the manifest the three lanes follow:
