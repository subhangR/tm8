...
**Review target:** `docs/architecture/WORKSPACE-LAYOUT-AND-TERMINOLOGY.md` (DRAFT, 2026-07-25)  
**Verdict:** **NO-GO**  
...
**Contradicted source:** draft `WORKSPACE-LAYOUT-AND-TERMINOLOGY.md:14-17,28-40`; `docs/architecture/01-LAWS.md:7-17,35-46,56-60`; `docs/architecture/02-NODE-AND-GATEWAY.md:35-48`; `docs/architecture/06-SEQUENCING-AND-REVIEW.md:18-25`; frozen `packages/contract/src/catalog.ts:30-142`.
...
**Contradicted source:** draft `WORKSPACE-LAYOUT-AND-TERMINOLOGY.md:3,15-17,24,90-93`; `docs/architecture/01-LAWS.md:41-48,82-84`; frozen `packages/contract/src/contract.ts:246-291`; `db/migrations/003_read_model.sql:294-319`; `STATE.md:126-160`.
...
**Contradicted source:** draft `WORKSPACE-LAYOUT-AND-TERMINOLOGY.md:18,79-86`; `docs/architecture/03-ENTITY-GRAPH-DELTAS.md:54-66`; `docs/architecture/05-DECISIONS.md:23`; frozen `packages/contract/src/contract.ts:626-685`; `db/migrations/001_core_graph.sql:240-271,329-345,762-772,785-792`.
...
**Contradicted source:** draft `WORKSPACE-LAYOUT-AND-TERMINOLOGY.md:81-86`; `docs/architecture/01-LAWS.md:23-27`; frozen `packages/contract/src/contract.ts:95-103,146-151,626-738`; `db/migrations/001_core_graph.sql:694-746,898-922`; `db/migrations/007_rpc_catalog.sql:748-854,2020-2113`.
...
**Contradicted source:** draft `WORKSPACE-LAYOUT-AND-TERMINOLOGY.md:81-84`; `docs/architecture/03-ENTITY-GRAPH-DELTAS.md:11-19`; frozen `packages/contract/src/contract.ts:618-624,700-738`; `db/migrations/001_core_graph.sql:691-746`; `db/migrations/007_rpc_catalog.sql:2020-2163`.
...
**Contradicted source:** draft `WORKSPACE-LAYOUT-AND-TERMINOLOGY.md:18,84-85`; frozen `packages/contract/src/contract.ts:95-97,532-540,651-695`; `docs/architecture/03-ENTITY-GRAPH-DELTAS.md:54-60`.
...
**Contradicted source:** draft `WORKSPACE-LAYOUT-AND-TERMINOLOGY.md:18,28-42,81-84`; `db/migrations/007_rpc_catalog.sql:748-830`; `docs/history/collab-v2/ui-plan/01-IMPLEMENTATION-PLAN.md:212-229`.
...
**Contradicted source:** draft `WORKSPACE-LAYOUT-AND-TERMINOLOGY.md:46-51,65-72`; `docs/history/collab-v2/ui-plan/01-IMPLEMENTATION-PLAN.md:98-105,125-137,170-184`; `packages/ui/src/collab-v2/stores/nav.ts:7-21,29-85,112-147,158-217`; `packages/ui/src/collab-v2/shell/ShellLayout.tsx:111-130`.
...
**Contradicted source:** draft `WORKSPACE-LAYOUT-AND-TERMINOLOGY.md:44-51,90-93`; `STATE.md:126-134`; `packages/ui/src/real/workspace/TaskPanel.tsx:1-24,158-179,195-260`; `packages/ui/src/real/workspace/ResourcePanel.tsx:15-44,73-203`; `docs/history/collab-v2/ui-plan/01-IMPLEMENTATION-PLAN.md:47-53,125-137`.
...
**Contradicted source:** draft `WORKSPACE-LAYOUT-AND-TERMINOLOGY.md:40,69-72`; `docs/history/collab-v2/ui-plan/01-IMPLEMENTATION-PLAN.md:170-184`; `packages/ui/src/collab-v2/stores/nav.ts:7-21,43-55,143-147,158-217`; `packages/ui/src/real/workspace/WorkspaceScreen.tsx:32-41`.
...
**Contradicted source:** draft `WORKSPACE-LAYOUT-AND-TERMINOLOGY.md:48-51,69-72`; `docs/history/collab-v2/ui-plan/01-IMPLEMENTATION-PLAN.md:188-208`; frozen `packages/contract/src/contract.ts:187-217`; `docs/architecture/01-LAWS.md:19-33`.
...
**Contradicted source:** draft `WORKSPACE-LAYOUT-AND-TERMINOLOGY.md:42,53-77,90-94`; `docs/history/collab-v2/ui-plan/01-IMPLEMENTATION-PLAN.md:212-250,267-280`; `docs/architecture/06-SEQUENCING-AND-REVIEW.md:5-7,13-16`; `STATE.md:77-91,201-218`; frozen `packages/contract/src/contract.ts:551-557`.
...
**Contradicted source:** draft `WORKSPACE-LAYOUT-AND-TERMINOLOGY.md:84-86`; `docs/architecture/01-LAWS.md:23-33`; frozen `packages/contract/src/contract.ts:162-176`.
...
**Contradicted source:** v2 `WORKSPACE-LAYOUT-AND-TERMINOLOGY.md:13,140`; frozen `packages/contract/src/contract.ts:95-97,489-496,651-660`; `packages/contract/src/schemas.ts:152-167,751-759`; `docs/architecture/05-DECISIONS.md:16`.
...
**Contradicted source:** v2 `WORKSPACE-LAYOUT-AND-TERMINOLOGY.md:99-106,118-121`; `packages/ui/src/collab-v2/stores/nav.ts:129-139`; `packages/ui/src/collab-v2/shell/PanelStack.tsx:220-278`; `packages/ui/src/collab-v2/shell/ShellLayout.tsx:125-131`; `docs/history/collab-v2/ui-plan/01-IMPLEMENTATION-PLAN.md:170-184`.
...
**Contradicted/insufficient source:** v2 `WORKSPACE-LAYOUT-AND-TERMINOLOGY.md:150-173`; `docs/history/collab-v2/ui-plan/01-IMPLEMENTATION-PLAN.md:141-165,188-208,212-280`; `STATE.md:89`.
...
**Contradicted source:** v2.1 `WORKSPACE-LAYOUT-AND-TERMINOLOGY.md:113-115,133-144,193`; `packages/ui/src/collab-v2/stores/nav.ts:29,129-139`; `packages/ui/src/collab-v2/shell/router.ts:101-152`; inherited `docs/history/collab-v2/ui-plan/01-IMPLEMENTATION-PLAN.md:175-184`.
...
**Contradicted/insufficient source:** v2.1 `WORKSPACE-LAYOUT-AND-TERMINOLOGY.md:153-175,185-186`; frozen `packages/contract/src/contract.ts:489-496,682-685`; `docs/architecture/05-DECISIONS.md:16`.
...
**Contradicted source:** v2.1 `WORKSPACE-LAYOUT-AND-TERMINOLOGY.md:55-85,207-209`; `docs/history/collab-v2/ui-plan/01-IMPLEMENTATION-PLAN.md:188-205`.
...
**Insufficient source:** v2.2 `WORKSPACE-LAYOUT-AND-TERMINOLOGY.md:192-197,209-210`; `docs/architecture/05-DECISIONS.md:16`.
...
**Insufficient source:** v2.2 `WORKSPACE-LAYOUT-AND-TERMINOLOGY.md:84-91`; inherited URL-addressability contract at `docs/history/collab-v2/ui-plan/01-IMPLEMENTATION-PLAN.md:188-205`.
...
**Contradicted/insufficient source:** v2.3 `WORKSPACE-LAYOUT-AND-TERMINOLOGY.md:168-176`; `docs/architecture/01-LAWS.md:82-84`; `packages/ui/src/real/workspace/Composer.tsx:82-102`; `packages/execution/src/spawn/SpawnService.ts:249-297`.
...
**Insufficient source:** v2.3 `WORKSPACE-LAYOUT-AND-TERMINOLOGY.md:168-176,230-231`; `docs/architecture/01-LAWS.md:41-48`; frozen kinds at `packages/contract/src/contract.ts:28-37`; threat posture at `docs/architecture/10-SECURITY-MODEL.md:9-16,36-42`.
...
**Contradicted source:** v2.3 `WORKSPACE-LAYOUT-AND-TERMINOLOGY.md:170-176,242`; inherited one-command/undo rule at `docs/history/collab-v2/ui-plan/01-IMPLEMENTATION-PLAN.md:233-250`; current `db/migrations/007_rpc_catalog.sql:1290-1373`; `packages/ui/src/collab-v2/interactions/execute.ts:1-15,62-115`.
...
**Insufficient source:** v2.3 `WORKSPACE-LAYOUT-AND-TERMINOLOGY.md:185-187`; terminal interception seam at `packages/ui/src/real/SessionTerminal.tsx:294-311`; inherited full-keyboard-path acceptance at `docs/history/collab-v2/ui-plan/01-IMPLEMENTATION-PLAN.md:254-265`.
...
**Contradicted source:** v2.3 `WORKSPACE-LAYOUT-AND-TERMINOLOGY.md:98`; `docs/architecture/01-LAWS.md:23-27`.
...
**Contradicted/insufficient source:** v2.4 `WORKSPACE-LAYOUT-AND-TERMINOLOGY.md:182-188,194,260-261`; T-L12 at `docs/architecture/01-LAWS.md:82-84`; current delivery seam at `packages/execution/src/pty/PtyHostService.ts:71-91,440-503,515-570`; `packages/execution/src/spawn/SpawnService.ts:249-297`.
...
**Insufficient source:** v2.4 `WORKSPACE-LAYOUT-AND-TERMINOLOGY.md:198-215`; tm8's web-only posture at `docs/architecture/04-EXECUTION-TRANSPLANT.md:3`.
...
**Contradicted/insufficient source:** v2.5 `WORKSPACE-LAYOUT-AND-TERMINOLOGY.md:189-195,200-202`; honest derived truth at `docs/architecture/01-LAWS.md:82-84`.
...
**Contradicted source:** G4 and the dossier delta at `WORKSPACE-LAYOUT-AND-TERMINOLOGY.md:282,298`; `docs/architecture/10-SECURITY-MODEL.md:38-40,63-70`; `docs/architecture/05-DECISIONS.md:26` (T-D22); frozen types at `packages/contract/src/contract.ts:693-696,717-738` and `packages/contract/src/schemas.ts:873-890`.
