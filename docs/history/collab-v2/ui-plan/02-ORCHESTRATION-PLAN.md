...
7. **Re-brief with reality.** Each wave's spawn briefs must describe what actually
   ...
   `docs/history/collab-v2/ui-plan/STATE.md` in the worktree — updated after every wave gate —
...
git checkout feat/collab-v2-supabase-backend -- \
  docs/history/collab-v2/ENTITY-GRAPH-DESIGN.md docs/COLLAB_V2_UI_UX_BRIEF.md \
  docs/history/collab-v2/UI-DATA-CONTRACT.md docs/history/collab-v2/GAPS-AND-EXTENSIONS.md \
...
- **Design sources for workers** (all inside the worktree after step 2):
  `docs/COLLAB_V2_UI_UX_BRIEF.md` (logical UI spec), `docs/history/collab-v2/UI-DATA-CONTRACT.md`
  (DTOs/commands/events — the law for L0), `docs/history/collab-v2/ENTITY-GRAPH-DESIGN.md`
