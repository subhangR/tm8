...
3. `docs/architecture/00-10`, including the T-D decision log, for adopted architecture;
...
|---|---|---|
| Product vision, laws, architecture, security and adoption history | `docs/architecture/00-10` | Master adopted corpus and T-D decision log. |
| Workspace layout, terminology, Project projections, M:N Projects, Terminal/Chat, profiles and message-first ruling | `docs/architecture/WORKSPACE-LAYOUT-AND-TERMINOLOGY.md` | v2.11 FINAL GO with RULINGS I–M and Round-12 delta closure. |
| Adversarial history | `docs/architecture/WORKSPACE-LAYOUT-REVIEW.md` | Finding-by-finding ledger and GO evidence. |
| Domain, entities and tables | `docs/architecture/DOMAIN-ARCHITECTURE-DECISIONS.md` | Grouped domain model, 43-table implemented baseline and amendment map. |
| Frozen and proposed API | `docs/api-and-cli/API-CATALOG-GROUPED-GUIDE.md` | All 81 frozen operations by family plus post-freeze amendment groups. |
| Complete CLI grammar | `docs/api-and-cli/CLI-GRAMMAR-REDESIGN.md` | Noun-first graph/domain grammar, output/errors/idempotency, 81-row disposition and proposed surfaces. |
| Messages, delivery, replies, inbox, attachments and handoffs | `docs/chat-and-messaging/SESSION-COMMUNICATION-MODEL.md` | Closed Round-4 message/delivery model and required schema/API guards. |
| Agent bootstrap, lazy command discovery and orchestration | `docs/harness/AGENT-HARNESS-AND-COMMAND-DISCOVERY.md` | Bounded prompt/context journey, provider-specific native launch and recovery/conformance rules. |
| Current implementation reality and Chat backend seams | `docs/chat-and-messaging/BACKEND-BRIEFING-FOR-CHAT-TEMPLATES.md` | Source-backed implemented/contracted/proposed distinctions, feed/profile/static-template rulings. |
| Complete Chat/Terminal UI and layout | `docs/chat-and-messaging/CHAT-UI-AND-LAYOUT-DESIGN.md` | Workspace placement, Terminal/Chat switch, feed/composer, delivery/inbox states, routes, keyboard, responsive and accessibility rules. |
| Exact W0 amendment authority | `docs/history/program-w0-w5/W0-AMENDMENT-DOSSIER.md` | A01–A20, frozen-row deltas, DTO/Zod/errors, authorization, SQL/RLS/locks/retention/backfill/repair/rollback, events, CLI and conformance. |
| Total W0 consistency proof | `docs/history/program-w0-w5/W0-CONSISTENCY-MATRICES.md` | Total kind and 81+20 operation matrices with shipped/adopted status. |
| W0 gate evidence | `docs/history/program-w0-w5/W0-GATE-REPORT.md` | Source counts, closure evidence, hashes, process audit and fresh Opus verdict. |
| W0-E G0.1 amendment evidence | `docs/history/program-w0-w5/W0-G0.1-AMENDMENT-REPORT.md` | Two-contradiction source proof, exact storage/RPC reconciliation, non-drift evidence, rotated hashes and binding reviewer. |
| W1–W5 handoff state | `docs/history/program-w0-w5/W0-W5-HANDOFF-STATE.md` | Wave entry gates, unstarted state, spawn/provider/polling invariants and risks. |
| Remote connection model | `docs/remote/PHASE-2-REMOTE-SERVER-INTEGRATION.md` | Separate Phase-2 control plane mapped onto the same local Server domain/API. |
