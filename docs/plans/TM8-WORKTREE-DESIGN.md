...
- **PRIOR** — inherited from `sess_1785384914507_78l2n90cm` via `docs/plans/TM8-NEW-ENTITIES-SESSION-DIGEST.md` §3.
...
- `docs/plans/MEMO-WORKTREE-SEAM-ANSWERS.md` — answers W1–W6 to the memories worker.
...
— lives **only** in `docs/tm8-architecture/10-SECURITY-MODEL.md` §5. `realpath` is called in the
...
`TM8-W0-W5-HANDOFF-STATE.md:2733`. This design **extends the 036/038 binding pattern to door twelve
