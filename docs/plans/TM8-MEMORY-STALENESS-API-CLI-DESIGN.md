...
**Status: DESIGN. Companion to `TM8-MEMORY-AND-STALENESS-DESIGN.md` (the data-model design; read it
...
the working tree read on 2026-07-27. Claims about the CLI follow `TM8-CLI-GRAMMAR-REDESIGN.md`
...
Grammar authority: `TM8-CLI-GRAMMAR-REDESIGN.md` §3-§4. Conventions honoured throughout: noun /
