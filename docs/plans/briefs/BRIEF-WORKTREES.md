...
conclusions were recovered on 2026-07-31 into `docs/plans/TM8-NEW-ENTITIES-SESSION-DIGEST.md` §3.
...
alone. Writing your own new documents under `docs/plans/` is expected and fine.

## 2. Read before you write

- `docs/plans/TM8-NEW-ENTITIES-SESSION-DIGEST.md` — §3 and §5 are yours
- `docs/plans/TM8-MEMORY-AND-STALENESS-DESIGN.md` — around line 353, the proposed worktree entity
- `docs/plans/reviews/TM8-MEMORY-STALENESS-DESIGN-REVIEW.md` — around line 166, the two ship-blockers
- `docs/tm8-architecture/10-SECURITY-MODEL.md` — the S11 realpath-containment rule, around line 36
- `docs/tm8-architecture/04-EXECUTION-TRANSPLANT.md`
...
Write to `docs/plans/TM8-WORKTREE-DESIGN.md` — this document does not exist yet and is the main
