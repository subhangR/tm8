...
`docs/plans/TM8-PROGRAM-CLOSE.md` first (it is the entry point, ~400 lines), then
`TM8-W0-W5-HANDOFF-STATE.md` §§15, 21–24 for the detail.
...
A design document at `docs/plans/TM8-MEMORY-AND-STALENESS-DESIGN.md`:
