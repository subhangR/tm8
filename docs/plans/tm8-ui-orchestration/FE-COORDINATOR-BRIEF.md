...
1. `CHARTER.md`
2. The canvases: `T0-1 Workspace Hi-Fi.dc.html` (the committed "ink stage" master screen — this IS the gate target), then T0-2…T4, T10, T3-3, T5-1, T5-2, T5-3, T5-5/T5-6, T5-7 in `/Users/subhang/Desktop/Projects/tm8/T0-1 workspace structure review (1)/`
