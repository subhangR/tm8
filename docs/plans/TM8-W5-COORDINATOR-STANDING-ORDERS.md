...
**Governing division:** `TM8-W5-DUO-STRUCTURE.md`. Nothing here replaces it; this file adds the
...
Per `TM8-W5-DUO-STRUCTURE.md` §1. Restated here only as the operative rule, because it is the
