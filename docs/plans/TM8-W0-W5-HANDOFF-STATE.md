...
**Authority:** `TM8-W0-AMENDMENT-DOSSIER.md` plus `TM8-W0-CONSISTENCY-MATRICES.md`; no worker may substitute an older proposal or infer a competing contract
...
| W3 | **IN PROGRESS — rolling gate authorized to overlap W2; resumed under §8** | user-authorized rolling override recorded in `TM8-W3-PUBLIC-AND-AGENTIC-EVIDENCE.md` §1 | independent verification of every W2 group through public HTTP/WS and database-observable outcomes, followed by agentic API discovery/use |
...
- `docs/plans/TM8-W0-G0.1-AMENDMENT-REPORT.md`
- `docs/plans/TM8-FINAL-DESIGN-SET.md`
- `docs/plans/TM8-FINAL-DESIGN-SET-REVIEW.md` §7
- `docs/plans/WORKSPACE-LAYOUT-AND-TERMINOLOGY.md` §§0, 2.1–2.3, 5.7–5.8, 7–8.2, 10
- `docs/plans/DOMAIN-ARCHITECTURE-DECISIONS.md` D16–D17 and §§5–8
- `docs/plans/TM8-SESSION-COMMUNICATION-MODEL.md` §§3, 5, 7–10, 13–15
- `docs/plans/TM8-AGENT-HARNESS-AND-COMMAND-DISCOVERY.md` §§4–8, 12, 15–17, 20, 22
- `docs/tm8-architecture/05-DECISIONS.md` T-D23
...
fa2c304a5ee24ee7c5d9eb47e157c38eb8d5aa6145b8a4a99046ae0a21f11c60  TM8-W0-CONSISTENCY-MATRICES.md (unchanged)
```
...
**Adopted substitution.** `TM8-IMPLEMENTATION-ORCHESTRATION-W0-W5.md` §2 is amended for
...
`TM8-W2-PREFLIGHT-AND-INTEGRATION-EVIDENCE.md` and
`TM8-W3-PUBLIC-AND-AGENTIC-EVIDENCE.md`. **The working tree contains uncommitted work
...
- `docs/plans/PHASE-2-REMOTE-SERVER-INTEGRATION.md` §4.1 — "The Server advertises its stable
...
> `schemas.ts:1716`). Those fields exist only in `TM8-AGENT-HARNESS-AND-COMMAND-DISCOVERY.md` §7.5 as
> *"should return"*, and the repo had already recorded at `TM8-AGENT-JOURNEY-WALKTHROUGH.md:747-748` that
...
`TM8-W3-PUBLIC-AND-AGENTIC-EVIDENCE.md`) already requires of every accepted group: *"mutation-ID
...
against evidence in a ledger document (`TM8-W2-PREFLIGHT-AND-INTEGRATION-EVIDENCE.md`,
`TM8-W3-PUBLIC-AND-AGENTIC-EVIDENCE.md`, `TM8-W4-CLI-IMPLEMENTATION-EVIDENCE.md`). Stale-status tasks
...
4. `TM8-W0-AMENDMENT-DOSSIER.md` — **zero hits for `savedViews`.** No adopted A-row requires a guard here.
...
`TM8-CLI-GRAMMAR-REDESIGN.md:577`, **zero** in the contract); the grammar doc spelling guard-bearing
...
`TM8-W3-PUBLIC-AND-AGENTIC-EVIDENCE.md:374` (*"no user or development database was touched"*), corroborated
at `TM8-W2-PREFLIGHT-AND-INTEGRATION-EVIDENCE.md:418` (*"the only genuine orphan… dropped by W3 itself.
...
**The countermeasure worked prospectively in the one place it mattered most.** `TM8-PROGRAM-CLOSE.md`
...
tasks, and **no git run by anyone at any point.** Entry point: `docs/plans/TM8-PROGRAM-CLOSE.md`.
