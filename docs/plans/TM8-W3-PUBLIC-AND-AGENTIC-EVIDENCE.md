...
- `TM8-IMPLEMENTATION-ORCHESTRATION-W0-W5.md`
...
- `TM8-W1-PREFLIGHT-AND-INTEGRATION-EVIDENCE.md`
- `TM8-W2-PREFLIGHT-AND-INTEGRATION-EVIDENCE.md`
...
`TM8-W0-AMENDMENT-DOSSIER.md` or `TM8-W0-CONSISTENCY-MATRICES.md` — the sole authority for W1–W5 —
and exists only in `TM8-API-CATALOG-GROUPED-GUIDE.md:137` labelled *"Proposed safety amendment"*.
