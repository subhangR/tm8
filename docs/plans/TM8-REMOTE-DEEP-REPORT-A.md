...
Also drifted (not the brief's fault — the tree moved): the 2026-07-29 status doc says the catalog has **106 operations, 104 v1** (`TM8-REMOTE-STATUS-2026-07-29.md:53-54`). Today it is **110 / 108 / 2** (`catalog.ts:174`, asserted at `packages/cli/test/catalog-exhaustiveness.test.ts:33,39-44`).
...
| `mintToken` | **ABSENT** everywhere in `packages/`. Exists only as a proposal in `TM8-REMOTE-END-TO-END-DESIGN.md:125,347,485,729` |
...
### `TM8-REMOTE-END-TO-END-DESIGN.md` (773 lines, 2026-07-27)
...
### `TM8-REMOTE-STATUS-2026-07-29.md` — re-verified bullet by bullet
...
**Docs** — `docs/plans/PHASE-2-REMOTE-SERVER-INTEGRATION.md` (321, binding boundary) · `docs/plans/TM8-REMOTE-END-TO-END-DESIGN.md` (773, draft) · `docs/plans/TM8-REMOTE-STATUS-2026-07-29.md` (202, audit)
