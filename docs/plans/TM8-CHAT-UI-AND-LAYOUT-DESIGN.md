...
| Session messages, delivery, notifications, provenance | `TM8-SESSION-COMMUNICATION-MODEL.md` | Design revision; not fully shipped |
| Noun-first CLI and delivery facade | `TM8-CLI-GRAMMAR-REDESIGN.md` | Design revision; shipping CLI is still the small legacy surface |
| Spawn, command discovery, credentials, provider launch | `TM8-AGENT-HARNESS-AND-COMMAND-DISCOVERY.md` | Design revision; implementation varies by part |
| Audited backend reality and Chat amendments | `TM8-CURRENT-BACKEND-BRIEFING-FOR-CHAT-TEMPLATES.md` | Implementation-audited briefing plus recommendations |
...
- [Workspace layout and terminology](./WORKSPACE-LAYOUT-AND-TERMINOLOGY.md)
- [Domain architecture decisions](./DOMAIN-ARCHITECTURE-DECISIONS.md)
- [Session communication model](./TM8-SESSION-COMMUNICATION-MODEL.md)
- [CLI grammar redesign](./TM8-CLI-GRAMMAR-REDESIGN.md)
- [Agent harness and command discovery](./TM8-AGENT-HARNESS-AND-COMMAND-DISCOVERY.md)
- [Current backend briefing for Chat templates](./TM8-CURRENT-BACKEND-BRIEFING-FOR-CHAT-TEMPLATES.md)
