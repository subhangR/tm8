...
> **Grammar scope.** Every command in this document exists in `TM8-CLI-GRAMMAR-REDESIGN.md` rev 4 §4.
...
it is **rollout step 1** in `TM8-HARNESS-FLAVORS-AND-ORCHESTRATION-PLAN.md` §13, and it is the only step that is
