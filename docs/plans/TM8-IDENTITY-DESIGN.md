...
*End of design. Deliverable for task `task_1785457738056_85pkqpuql`; companion documents in this directory: `IDENTITY-DESIGN-BRIEF.md` (the brief), `TM8-AUTH-AND-IDENTITY-BRIEF.md` rev 3, `TM8-REMOTE-DEEP-REPORT.md`, `TM8-REMOTE-DEEP-REPORT-B.md` (verified current state).*
