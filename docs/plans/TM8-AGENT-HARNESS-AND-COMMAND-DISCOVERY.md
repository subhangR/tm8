...
**Intended canonical path:** `docs/plans/TM8-AGENT-HARNESS-AND-COMMAND-DISCOVERY.md` in the tm8 repository  
...
1. frozen decisions in `docs/plans/WORKSPACE-LAYOUT-AND-TERMINOLOGY.md` v2.11 and `docs/plans/DOMAIN-ARCHITECTURE-DECISIONS.md`;
...
4. section 11.5 and related work-session/profile rulings in `docs/plans/TM8-CURRENT-BACKEND-BRIEFING-FOR-CHAT-TEMPLATES.md`;
5. `docs/tm8-architecture/00-10` and `docs/collab-v2-api-design/00-05` for architecture and UX constraints;
