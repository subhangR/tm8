...
**Sources:** `TM8-AGENT-HARNESS-AND-COMMAND-DISCOVERY.md` (authority for bootstrap/discovery/orchestration),
`TM8-CLI-GRAMMAR-REDESIGN.md` rev 4 (verb surface), `TM8-SESSION-COMMUNICATION-MODEL.md` rev 5
(messages/delivery, incl. B1/B2 closure), `TM8-W0-AMENDMENT-DOSSIER.md` (sole W1–W5 design authority),
`TM8-FINAL-DESIGN-SET.md` (authority order).

**Authority order when docs disagree** (final-set §1, highest first): shipped migrations and package source →
`packages/contract/src/catalog.ts` + DTO/Zod → `docs/tm8-architecture/00-10` + T-D log →
...
> `TM8-HARNESS-FLAVORS-AND-ORCHESTRATION-PLAN.md` §2.3–2.4 and amendment F16.
