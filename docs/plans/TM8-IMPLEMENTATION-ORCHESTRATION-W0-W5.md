...
3. `docs/tm8-architecture/00-10`, including the T-D decision log.
4. `docs/plans/WORKSPACE-LAYOUT-AND-TERMINOLOGY.md` v2.11 and `WORKSPACE-LAYOUT-REVIEW.md` through Round 12.
5. The W0-approved amendment dossier becomes the sole authority for W1–W5 changes.
6. The subordinate companions indexed by `TM8-FINAL-DESIGN-SET.md` explain domain, API, CLI, communication, harness, UI and remote boundaries.

The final independent review is `TM8-FINAL-DESIGN-SET-REVIEW.md`. Its B1/B2 blockers and required major repairs are mandatory W0 inputs, not implementation TODOs to ignore.
