...
**Entry authority:** amendment **M-2** (`TM8-W0-W5-HANDOFF-STATE.md` §9) — user-authorized parallel start, **not** a fresh G3 APPROVE
...
```text
b85a18304f3769ba88da67403a7d90331a17c6355df7b451d650b49990434805  TM8-W0-AMENDMENT-DOSSIER.md
...
`TM8-W2-PREFLIGHT-AND-INTEGRATION-EVIDENCE.md` and `TM8-W3-PUBLIC-AND-AGENTIC-EVIDENCE.md`
...
2. `TM8-W0-AMENDMENT-DOSSIER.md` §4/§7 + `TM8-W0-CONSISTENCY-MATRICES.md` §3 — DTOs, closed
   error taxonomy, per-row CLI command path, 12 detailed capability grammars
3. `TM8-CLI-GRAMMAR-REDESIGN.md` — global options, exit codes, output law, per-command flags,
   help/completion
4. `TM8-AGENT-HARNESS-AND-COMMAND-DISCOVERY.md` — help JSON shapes, byte caps, manifest,
...
| `TM8-W0-AMENDMENT-DOSSIER.md` | does not mention `savedViews` **at all** — nothing to amend |
...
**Full detail, ordered for a first-day reader: `docs/plans/TM8-W4-CLI-HANDOFF.md`.**
