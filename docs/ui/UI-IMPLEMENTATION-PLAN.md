...
**Status:** DRAFT for review. Companion to `UI-SPEC-FINAL.md` (what to build) — this document is *how, in what order, and how we know each stage is done*.
**Date:** 2026-07-27.
...
|---|---|---|---|
| P1 | The v2.11 design is sound and buildable | ✅ | 12 adversarial review rounds (FINAL GO) + independent Fable-5 architecture review → `UI-SPEC-FINAL.md` |
