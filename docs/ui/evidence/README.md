...
- Originals are preserved untouched at `/home/tm8/prod-data/clipboard/019fbd5a/` and in the session scratchpad; nothing was edited.
...
- **pending (in train)**: 5 (Task detail #550, Maestro/list rows #549, Home/global nav #545, Switcher #548-merged-pending-deploy, plus #549's caption scope)
