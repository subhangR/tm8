...
| **Measured against** | `packages/contract` (81-op catalog + kinds) · `docs/history/collab-v2/UI-DATA-CONTRACT.md` · `docs/history/collab-v2/ui-plan/` · `COLLAB_V2_UI_UX_BRIEF.md` (⚠ not in this repo — see D-0) · old maestro's shipped UI |
...
- **The vendored UI data contract is stale.** `UI-DATA-CONTRACT.md` still specifies
