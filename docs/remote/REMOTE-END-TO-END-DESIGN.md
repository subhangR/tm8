...
**Date:** 2026-07-27
**Dependencies:** `docs/remote/PHASE-2-REMOTE-SERVER-INTEGRATION.md` (binding boundary — its §2 invariants are not relitigated here, its §11 is the 15-item checklist this document closes), `docs/architecture/WORKSPACE-LAYOUT-AND-TERMINOLOGY.md` v2.11 FINAL GO, `docs/architecture/05-DECISIONS.md`, and the three research briefs (corpus, code, clients) prepared for this design pass.
